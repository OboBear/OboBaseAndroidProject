...
public class AdView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(rLayout != null) {
	        ViewGroup.LayoutParams rLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        if(fLayout != null) {
	        ViewGroup.LayoutParams fLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
	...
	void resizeAdLayout() {
        ...
        if(fLayout != null) {
	        ...
	        if(fLayoutParams1 == null) {
	            ...
	            fLayoutParams1 = new FrameLayout.LayoutParams(displayWidth, displayHeight);
	        } else {
