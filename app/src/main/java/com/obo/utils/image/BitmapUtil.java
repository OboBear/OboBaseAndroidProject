...
public class BitmapUtil
{
    ...
    /**
     * Load bitmap file from drawable id
     * @param context Activity context
     * @param resId the drawable id
     * @return The Bitmap object, the returned value may be null.
     */
    public static Bitmap loadBitmapById(Context context,int resId)
    {
     ...
     * @return
     */
    public static Bitmap createPorterDuffBitmap(Bitmap dst,Bitmap src) {

        Bitmap destCopy = dst.copy(Bitmap.Config.ARGB_8888, true);

        Canvas canvas = new Canvas(destCopy);
        Paint porterDuffPaint = new Paint();
        porterDuffPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        canvas.drawBitmap(src, 0, 0, porterDuffPaint);
     ...
     * @return
     */
    public static Bitmap makeCirclePorterDuffBitmap(Bitmap dst,float startAngle,float sweepAngle) {

        Bitmap coverBitmap = Bitmap.createBitmap(dst.getWidth(),dst.getHeight(),Config.ARGB_8888);
